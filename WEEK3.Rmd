...
print(Enrollment)
```
The three database demonstrate normalization such as making sure a single column has a single value, adding primary key and having all attributes depends on the primary key and only on the primary key.
...
#find matches that have that first and last character to be the same and have at least one the same repeating character in between
