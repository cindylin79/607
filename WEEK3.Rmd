...
print(Enrollment)
```
Goal of normalization - efficiency, consistency, and accuracy. Students table shows 1NF as it has a primary key, consistent data type and no repeating groups in the column. 
